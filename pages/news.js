...
const news = () => {
    return (
        <div>
            <Head>
                <title>Future Tech News | Must Know</title>
            ...
            <div class="m-20 bg-black flex items-center justify-center">
                <div class="grid grid-cols-6 gap-2 px-16">
                    <div class="flex flex-col gap-1">
                        ...
                        <a href="#" class="hover:text-purple-500 text-gray-200 font-semibold"> AI/ML </a>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <a href="#" class="hover:text-purple-500 text-gray-200 font-semibold"> Quntam Computers </a>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <a href="#" class="hover:text-purple-500 text-gray-200 font-semibold"> SpeceX </a>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <a href="#" class="hover:text-purple-500 text-gray-200 font-semibold"> JavaScript</a>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <a href="#" class="hover:text-purple-500 text-gray-200 font-semibold"> Cloud Tech </a>
